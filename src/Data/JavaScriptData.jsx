  ...
  [
    {
      ...
      "imageStyle": "javaScriptProjectImage",
      "imageContainer": 'javaScriptImageContainer',
      "projectClass": "javaScriptImageRightTextContainer",
      "projectType": 'JavaScript Project',
      "projectLink": "https://github.com/coreyNance/Car_Enthusiast_Quiz",
      "textContainer": 'javaScriptTextContainer',
    ...
    },
    {
        ...
        "imagePath":require('../components/Project-Components/javaScriptProjects/javaScript_images/DailyPlannerBig.png'),
        "imageStyle": "javaScriptProjectImage",
        "imageContainer": 'javaScriptImageContainer',
        "projectClass": "javaScriptImageLeftTextContainer",
        "projectType": 'JavaScript Project',
        "projectImgSize": 'javaScriptProjectImage',
        "projectLink": "https://github.com/coreyNance/Daily_Planner",
        "textContainer": 'javaScriptTextContainer',
        "description": 'A calendar application that allows a user to save events for each hour of the day. This app runs in the browser and features dynamically updated HTML and CSS powered by jQuery. Moment.js library is used for the date and time.A program created as a car quiz with responsive design ques in mind. Time is deducted for wrong answers and high scores are saved and can be cleared.  HTML, CSS, JavaScript and Local storage were used for this assignment. This project showcases a mission-driven skill to create an application that utilizes JavaScript and CSS to dynamically show and hide features.'
    },
    {
      "id": 3,
      ...
      "textContainer": 'javaScriptTextContainer',
      "description": 'The task is to add functionality to an existing Budget Tracker application to allow for offline access and functionality. The user will be able to add expenses and deposits to their budget with or without a connection. When entering transactions offline, they should populate the total when brought back online. When Offline Functionality is , Enter deposits offline, Enter expenses offline then when brought back online, Offline entries should be added to tracker.'
  },
  {
    "id": 4,
...
},
{
  ...
  "textContainer": 'javaScriptTextContainer',
  "description": 'The task was to create a program to be able to generate a readme using inquirer. User is to be able to enter everything they want including the description and then be able to generate readme dynamically. Also if user doesnt want a section, they are to not see an empty section that they dont want. Each section of the readme is set up in different functions.'
},
